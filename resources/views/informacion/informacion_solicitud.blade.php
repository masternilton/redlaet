 ...
 <ul class="nav nav-tabs md-tabs nav-justified">
    <li class="nav-item">
        <a class="nav-link active" data-toggle="tab" href="#panel1" role="tab">Datos Solicitud Usuario</a>
    </li>
          ...
          <section class="content" >
            ...
            <div class="box box-primary  box-gris">
              ...
              <div class="box-body">
                  ...
                  <table class="table table-striped" style='line-height: 0.1;'>
  <thead>
    ...
    <tr>
      ...
      <td>    <span style='margin-left:10px; '>{{ $usuario->email }}</span>  </td>
                      ...
                      <div class="form-group">
                       <button type="button" class="btn btn-sm btn-primary" onclick='CO_aprobar_solicitud({{"'".$clavesol."'"}});' >Aprobar solicitud</button>
                       <button type="button" class="btn  btn-sm btn-default" onclick='CO_quitar_solicitud({{"'".$clavesol."'"}})'>Archivar solicitud</button>
                      </div>
