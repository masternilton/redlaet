...
<div class="box-body box-white">
    ...
    <div class="table-responsive" >
    	...
    	<table  class="table table-hover table-striped" cellspacing="0" width="100%">
	    	  <thead>
						<tr>    
							...
							<th colspan='5'>Listado coordinador general</th>
								<th >
							 <form method='post' style='width:80px;' target='_blank' action="{{ url('reporte_pdf_coordinadoresGlobal') }}">
	    ...
	    <table  class="table table-hover table-striped" cellspacing="0" width="100%">
	    	  <thead>
						<tr>    
							...
							<th colspan='5'>Listado coordinadores regiones</th>
								<th >
		...
		<tr role="row" class="odd" id='TR_usuario_{{ $usuario->id }}'>
           ...
           <td id='LU_region_{{$usuario->id}}' >{{ $usuario->region_rol }}</td>
			<td>
			@if($usuario->id==Auth::user()->id )
			<button type="button" class="btn-default btn-super-xs" onclick="verinfo_mi_perfil({{  $usuario->id }})" title='editar' ><i class="fa fa-fw fa-edit"></i></button>
			@else
		...
		<table  class="table table-hover table-striped" cellspacing="0" width="100%">
	    	  <thead>
						<tr>    
							...
							<th colspan='5'>Listado coordinadores Pais</th>
								<th >
		...
		<table  class="table table-hover table-striped" cellspacing="0" width="100%">
	    	  <thead>
						<tr>    
							...
							<th colspan='5'>Listado coordinadores Zona</th>
							<th >
