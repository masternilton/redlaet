...
<div class="box-body box-white">
    ...
    <div class="table-responsive" >
	    ...
	    <table  class="table table-hover table-striped" cellspacing="0" width="100%">
	    	    ...
	    	    <thead>
						<tr>    
							...
							<th colspan='6'>Listado Solicitudes de registro</th>
		...
		<tr role="row" class="odd" id='TR_usuario_{{ $usuario->id }}'>
			...
			<button type="button" class="btn-default btn-super-xs" onclick="verinfo_solicitud({{  $usuario->id }})" title='editar' ><i class="fa fa-fw fa-eye"></i> revisar</button>
