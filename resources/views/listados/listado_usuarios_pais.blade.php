...
<div class="box box-primary box-gris">
     ...
     <div class="box-header">
         ...
         @include('menus.menu_seccion_coordinador') 
...
<div class="box-body box-white">
    ...
    <div class="table-responsive" >
	    ...
	    <table  class="table table-hover table-striped" cellspacing="0" width="100%">
	    	    <thead>
						<tr>    
							...
							<th colspan='5'>Listado usuarios de su Pais</th>
								<th >
							 <form method='post' style='width:80px;' target='_blank' action="{{ url('reporte_pdf_usuarios_pais') }}">
	    ...
	    <tr>
	   	<form method="post"  action="{{ url('listado_usuariospais_filtro') }}"  >
	   		  <input type="hidden" name="_token" value="<?php echo csrf_token(); ?>"> 
		...
		<tr role="row" class="odd" id='TR_usuario_{{ $usuario->id }}'>
			...
			<td class="mailbox-messages mailbox-name"><a href="javascript:void(0);"  style="display:block"><i class="fa fa-user"></i>&nbsp;&nbsp;<span id='LU_nombres_{{$usuario->id}}'>{{ $usuario->name  }}</span></a></td>
...
<label style='color:#177F6B'>
              ... no se encontraron resultados para su busqueda en el pais ...
</label> 
