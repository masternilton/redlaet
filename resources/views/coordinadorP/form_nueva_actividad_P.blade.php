 ...
 <div class="col-md-12">
  ...
  <div class="box box-primary  box-gris">
    ...
    <div class="box-body">
      ...
      <form   action="{{ url('coordinador/crear_actividad_P') }}"  method="post" id="f_crear_actividad_P" >
...
<!--<div class="custom-control custom-radio">
  ...
  <label class="custom-control-label" for="todos">Todos los Coordinadores de zonas en mi País</label>
</div>-->
