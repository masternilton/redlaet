...
<div class="box box-primary box-gris">
     ...
     <div class="box-header">
         @include('encabezados.encabezado_coordinadores') 
         @include('menus.menu_actividades_coordinadorP') 
    </div>
    ...
    <div class="table-responsive" >
	    ...
	    <table  class="table table-hover table-striped" cellspacing="0" width="100%">
	    	  <thead>
						<tr>    
							...
							<th colspan='4'>Listado de Actividades activas del Coordinador</th>
	   ...
	   <tr>
		...
		<tr role="row" class="odd" id='TR_actividad_{{ $actividad->id }}'>
			...
			<td style='font-size: 0.8em;'>{{  $actividad->nom_creador }}</td>
		    ...
		    <td>
		    <button type="button" class="btn-default btn-super-xs" onclick="ACT_ver_actividad_P({{  $actividad->id }})" title='editar' ><i class="fa fa-fw fa-edit"></i></button>
            <button type="button" class="btn-default btn-super-xs" onclick="ACT_activar_actividad_P({{  $actividad->id }})" title='rol' ><i class="fa fa-fw fa-check"></i></button>
			<button type="button"  class="btn-danger btn-super-xs"  onclick="ACT_borrado_actividad_P({{  $actividad->id }});"  title='borrar' ><i class="fa fa-fw fa-remove"></i></button>
			</td>
		</tr>
	    @endforeach
