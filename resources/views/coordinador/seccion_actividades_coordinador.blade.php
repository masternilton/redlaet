...
<div class="box box-primary box-gris">
     ...
     <div class="box-header">
         ...
         @include('menus.menu_actividades_coordinador') 
    </div>
    ...
    <div class="table-responsive" >
	   ...
	   <tr>
		...
		<tr role="row" class="odd" id='TR_actividad_{{ $actividad->id }}'>
		    ...
		    <td>
		    <button type="button" class="btn-default btn-super-xs" onclick="ACT_ver_actividad_R({{  $actividad->id }})" title='editar' ><i class="fa fa-fw fa-edit"></i></button>
            <button type="button" class="btn-default btn-super-xs" onclick="ACT_activar_actividad_R({{  $actividad->id }})" title='rol' ><i class="fa fa-fw fa-check"></i></button>
			<button type="button"  class="btn-danger btn-super-xs"  onclick="ACT_borrado_actividad_R({{  $actividad->id }});"  title='borrar' ><i class="fa fa-fw fa-remove"></i></button>
			</td>
		</tr>
	    @endforeach
