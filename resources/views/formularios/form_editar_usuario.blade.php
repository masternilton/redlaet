...
<ul class="nav nav-tabs md-tabs nav-justified">
    ...
    <li class="nav-item">
        <a class="nav-link" data-toggle="tab" href="#panel2" role="tab">Acceso</a>
    </li>
    <li class="nav-item">
...
<div class="tab-content card">
          ...
          <section class="content" >
            ...
            <div class="box box-primary  box-gris">
              ...
              <div class="box-body">
                  ...
                  <form   action="{{ url('editar_usuario') }}"  method="post" id="f_editar_usuario"  class="form_B"  >
                  ...
                  <div class="row">
                      ...
                      <div class="col-md-6">
                              <div class="form-group  ">
                                <label class="col-sm-10" for="nombre">Nombres*   </label>
                                <div class="col-sm-10" >
                      ...
                      <div class="col-md-6">
                                <div class="form-group  ">
                                  <label class="col-sm-10" for="apellido">Apellido*</label>
                                  <div class="col-sm-10" >
                                  <span class="help-block" > </span>  
                      ...
                      <div class="col-md-6">
                        <div class="form-group ">
                          <label class="col-sm-10" for="pais">Pais*   </label>
                          <div class="col-sm-10" >
                          <span class="help-block" >   </span>
                      ...
                      <div class="col-md-6">
                                <div class="form-group ">
                                  <label class="col-sm-10" for="ciudad">Ciudad</label>
                                  <div class="col-sm-10" >
                                  <span class="help-block" > </span>  
                      ...
                      <div class="col-md-6">
                                <div class="form-group  ">
                                  <label class="col-sm-10" for="telefono">Telefono</label>
                                  <div class="col-sm-10" >
                                  <span class="help-block" > </span>  
                    ...
                    <div class="col-md-6">
                        <div class="form-group  ">
                          <label class="col-sm-10" for="ocupacion">Ocupacion</label>
                          <div class="col-sm-10" >
                          <span class="help-block" > </span>  
                    ...
                    <div class="col-md-6">
                        <div class="form-group  ">
                          <label class="col-sm-10" for="institucion">Institucion</label>
                          <div class="col-sm-10" >
                          <span class="help-block" > </span>  
            ...
            <div class="col-md-12">
             ...
             <div class="box box-primary  box-gris">
               ...
               <div class="box-body">
                 ...
                 <form   action="{{ url('editar_acceso') }}"  method="post" id="f_editar_acceso" class="form_B" >
                   <input type="hidden" name="_token" value="<?php echo csrf_token(); ?>"> 
                   <input type="hidden" name="id_usuario" value="{{ $usuario->id }}"> 
                   ...
                   <div class="box-header with-border my-box-header col-md-12" style="margin-bottom:15px;margin-top: 15px;">
                           ...
                           <div class="col-md-6">
                             ...
                             <div class="col-md-6">
                               <div class="form-group ">
                                   <label class="col-sm-12" for="email">Password*</label>
                                   <div class="col-sm-12" >
                                   <span class="help-block" ></span> 
    ...
    <div class="tab-pane fade" id="panel3" role="tabpanel">
        ...
        <div class="card testimonial-card">
            ...
            <div class="avatar mx-auto white"  style='width:200px;'><img id='avatar_usuario_{{ $usuario->id }}' src="{{ 'http://etnomatematica.org/apprelaet/storage/app/public/'.$usuario->url_imagen  }}?=<?=rand(1,32000)?>"  style='width:200px; height:200px;'>
            @else
            ...
            <div class="card-body">
                ...
                <form   action="{{ url('editar_imagen') }}"  method="post" id="f_editar_imagen" class="form_C" >
    ...
    <div class="tab-pane fade" id="panel4" role="tabpanel">
        ...
        @include('formularios.form_estudios')
    </div>
</div>
