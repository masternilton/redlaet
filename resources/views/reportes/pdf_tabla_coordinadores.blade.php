	    ...
	    <table    >
				...
				<thead>
						...
						<tr style='background-color:#dee2e6; padding-top: 10px; padding-bottom: 10px;'>    
							...
							<th colspan='5'  style=' padding-top: 10px; padding-bottom: 10px;' >LISTADO COORDINADORES REGION </th>
		  ...
		  <table    >
				...
				<thead>
						...
						<tr style='background-color:#dee2e6; padding-top: 10px; padding-bottom: 10px;'>    
							...
							<th colspan='5'  style=' padding-top: 10px; padding-bottom: 10px;' >LISTADO COORDINADORES ZONA </th>
