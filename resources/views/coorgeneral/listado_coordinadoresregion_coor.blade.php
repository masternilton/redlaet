    ...
    <table  class="table table-hover table-striped" cellspacing="0" width="100%">
	    	  <thead>
						<tr>    
							...
							<th colspan='6'>Listado coordinadores Region </th>
						    <th >
							 <form method='post' style='width:80px;' target='_blank' action="{{ url('reporte_pdf_coordinadoresRegGlobal') }}">
		...
		<tr role="row" class="odd" id='TR_usuario_{{ $usuario->id }}'>
           ...
           <td>
				<span class="label label-default" style='font-size:0.8em; ' id='LU_region_rol_{{$usuario->id}}'>
					{{$usuario->region_rol}}
