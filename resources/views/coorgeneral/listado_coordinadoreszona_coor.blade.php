	    ...
	    <table  class="table table-hover table-striped" cellspacing="0" width="100%">
	    	   <thead>
						<tr>    
							...
							<th colspan='8'>Listado coordinadores Zona</th>
							  <th >
							 <form method='post' style='width:80px;' target='_blank' action="{{ url('reporte_pdf_coordinadoresZonaGlobal') }}">

							 	<input type="hidden" name="_token" value="<?php echo csrf_token(); ?>">	

                               <button class='btn-default btn-super-xs' style='width: 100%;'><i class="fa fa-file-pdf-o" aria-hidden="true" style='margin-right: 20px;'></i>PDF
                               </button>
