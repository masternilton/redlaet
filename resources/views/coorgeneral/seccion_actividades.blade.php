    ...
    <div class="table-responsive" >
	    ...
	    <table  class="table table-hover table-striped" cellspacing="0" width="100%">
	    	  <thead>
						<tr>    
							...
							<th colspan='4'>Listado de Actividades activas del sistema</th>
	   ...
	   <tr>
		...
		<tr role="row" class="odd" id='TR_actividad_{{ $actividad->id }}'>
            ...
            <button type="button" class="btn-default btn-super-xs" onclick="ACT_activar_actividad({{  $actividad->id }})" title='rol' ><i class="fa fa-fw fa-check"></i></button>
